return {
	...
	overrides = {
        ...
        start_location="plus",                 --     World | Spawn Area                                                         plus (Plus) darkness (Dark) default (Default) 
        branching="most",                      --     World | Branches                                                           never (Never) least (Least) default (Default) most (Most) random (Random) 
